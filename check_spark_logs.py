#!/usr/bin/env python3
"""
Spark Lambda Logs Checker
"""

import boto3
from datetime import datetime, timedelta

def check_spark_lambda_logs():
    """Check CloudWatch logs for the Spark launcher Lambda function."""
...
if __name__ == "__main__":
    print("🚀 Spark Lambda Log Checker")
    print("=" * 50)
    check_spark_lambda_logs()
