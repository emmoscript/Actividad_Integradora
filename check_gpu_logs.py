#!/usr/bin/env python3
"""
GPU Lambda Logs Checker
"""

import boto3
from datetime import datetime, timedelta

def check_gpu_lambda_logs():
    """Check CloudWatch logs for the GPU processing Lambda function."""
...
if __name__ == "__main__":
    print("🚀 GPU Lambda Log Checker")
    print("=" * 50)
    check_gpu_lambda_logs()
